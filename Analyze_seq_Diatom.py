...
def ard2(file, pattern) :
	...
	for p in proteoms :
		...
		print(base)
		if base in basename(p) or basename(p) == 'New_Proteom_All.txt' : 
			print(base)
			print(basename(p))
			print(basename(file))
			with open(p, "r") as filin :
...
def dataframe_maker(dico_ard2, dico_radar, pattern_prot_all, pattern_idt) :
...
if __name__ == '__main__' :
	...
	#path_output = "/Users/rgoulanc/Desktop/Rebecca/FAC/M2BI/Stage/LAFONTAINE/script/Celine/algue_rouge/"
